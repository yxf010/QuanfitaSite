# Generated by Django 2.2.1 on 2019-09-20 03:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '男'), ('female', '女'), ('none', '保密')], default='none', max_length=7, verbose_name='性别')),
                ...
                ('image', models.ImageField(default='media/user/default.png', max_length=500, upload_to=User.models.upload_to, verbose_name='头像')),
                ('signature', models.CharField(default='', max_length=100, verbose_name='个性签名')),
